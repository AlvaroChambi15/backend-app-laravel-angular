    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                ...
                <h1 style="color:white; font-size:60px; margin:0px; margin-top:15px;-webkit-text-stroke: 2px black;">
                    BA<small>KALY</small>
                </h1>
                <div
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a
                                    class=" text-gray-900 dark:text-white">Notificaciones</a></div>
                        </div>
                            ...
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <li>
                                    <label>La <a
                                        ...
                                        dice que la Chesly es una Burra :V </label>
                                </li>
                            </div>
                        </div>
                    </div>
